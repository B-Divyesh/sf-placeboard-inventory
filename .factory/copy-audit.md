...
Audited 2026-08-28. Counts treat hyphenated terms as one word.

| Visible string | Words | Result |
| --- | ---: | --- |
...
| Inventory data stays on this device. | 6 | Pass |
| All inventory tools are free. | 5 | Pass |
...
| This household inventory stays in this browser. | 7 | Pass |
| It does not value items or run a warehouse. | 9 | Pass |
...
| A quantity change between places | move |
| Count of an item at a place | quantity |
| Safe try-out using sample data | demo |
| Downloaded copy of user data | export |
